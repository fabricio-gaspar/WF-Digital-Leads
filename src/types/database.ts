...
export type Database = {
  public: {
    Tables: {
      ...
      leads: { Row: { id: string; organization_id: string; company: string; contact: string | null; title: string | null; phone: string | null; email: string | null; segment: string | null; uf: string | null; distance: number | null; score: number; temp: string; stage: string; value: number; owner: string; assigned_to: string | null; stale_hours: number; escalated: boolean; escalation_reason: string | null; sla_info: string | null; last_contact: string | null; lost_reason: string | null; origin: string | null; created_at: string; updated_at: string; annual_revenue: string | null; score_snapshot: Json | null; score_explanation: string | null; score_source: string | null; score_verified_at: string | null; whatsapp: string | null; opt_out: boolean; owner_id: string | null; next_action_at: string | null; contact_channels: Json | null; ai_paused: boolean; city: string | null; size: string | null; pipeline_stage_id: string | null; escalated_reason?: string | null; contact_approval_status: string | null; first_outreach_at: string | null; first_inbound_at: string | null; no_reply_deadline_at: string | null; conversation_opened_at: string | null; no_reply_processed_at: string | null; approach_type: string | null; approach_set_at: string | null }; Insert: any; Update: any }
    ...
    Enums: { 
      lead_stage: "Prospecção" | "Qualificado" | "Proposta" | "Negociação" | "Pedido" | "Fechado" | "Perdido" | "Contatos Perdidos"
    }
